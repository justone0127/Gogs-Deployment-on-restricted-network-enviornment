...
- gogs deployment
  ...
  ![01_gogs_template](C:\Works\01_자료\01_OCP\05_OCP_Demo_hyou\gogs\01_gogs_template.png)

- gogs topolozy 

  배포가 완료되면 다음과 같이 `gogs-postgresql` Pod와 `gogs` Pod가 정상적으로 올라옵니다.

  ![02_topolozy](C:\Works\01_자료\01_OCP\05_OCP_Demo_hyou\gogs\02_topolozy.png)
...
![03_gogs](C:\Works\01_자료\01_OCP\05_OCP_Demo_hyou\gogs\03_gogs.png)
